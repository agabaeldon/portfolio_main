...
import { eyitMediaData } from "../../data/projects/eyitMedia";
import { FiCheck, FiExternalLink, FiDownload } from "react-icons/fi";

const EyitMediaDetail = () => {
  const project = eyitMediaData;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              {project.downloadUrl && (
                <a href={project.downloadUrl} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 w-full outline-btn">
...
export default EyitMediaDetail;
