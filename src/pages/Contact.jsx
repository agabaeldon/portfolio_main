    ...
    <section className="container py-12 grid grid-cols-1 md:grid-cols-2 gap-8 dark:text-white">
      <div>
        ...
        <div className="grid gap-3">
          <a href="mailto:agabaeldon@gmail.com" className="p-3 rounded-xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 hover:shadow">
          ...
          <div className="p-3 rounded-xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800">
            ...
            <div className="flex gap-4">
              <a href="tel:+256765026870" className="underline">0765026870</a>
              <a href="tel:+256751501556" className="underline">0751501556</a>
            </div>
          </div>
        </div>
      </div>
